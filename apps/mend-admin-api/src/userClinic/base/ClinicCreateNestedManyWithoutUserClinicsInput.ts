...
@InputType()
class ClinicCreateNestedManyWithoutUserClinicsInput {
...
export { ClinicCreateNestedManyWithoutUserClinicsInput as ClinicCreateNestedManyWithoutUserClinicsInput };
