...
export class RoleResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Permission], { name: "permission" })
  @nestAccessControl.UseRoles({
    resource: "Permission",
    action: "read",
    possession: "any",
  ...
  async findPermission(
    ...
    const results = await this.service.findPermission(parent.id, args);
  ...
  async getUserRoles(@graphql.Parent() parent: Role): Promise<User | null> {
